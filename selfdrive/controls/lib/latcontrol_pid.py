...
class LatControlPID():
  ...
  def update(self, active, CS, CP, VM, params, last_actuators, desired_curvature, lat_plan):
    ...
    angle_steers_des_no_offset = math.degrees(VM.get_steer_from_curvature(-desired_curvature, CS.vEg, params.roll))
    ...
    if CS.vEgo < 0.3 or not active:
      ...
      if self.model.active:
        ...
        pid_log.p = 0
        pid_log.i = 0
        pid_log.f = angle_steers_des # desired angle, good for plotting
      #/Parse the model info
